...
#lista de clinicas unicas para menu desplegable
clinic_list = df["Clinic Name"].unique()

#fuente de origen del paciente
        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.B("Volumen de Paciente por dia de la Semana"),
                        html.Hr(),
